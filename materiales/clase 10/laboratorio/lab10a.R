...
# Daniel Ciganda                                                               # 
# Laboratorio: Simulación de números aleatorios de exponencial                 # 
...
# Graficar
# Crear histogramas con nuestra muestra y la muestra obtenida con rexp()
# usar add = TRUE en el segundo histrograma, para superponerlos
